...
namespace Mozlite.Mvc.TagHelpers
{
    ...
    {
        private const string ModeAttributeName = "x-hidden-mode";
        ...
        public HiddenMode Mode { get; set; }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (hidden)
            {
                if (Mode == HiddenMode.Display)
                {
                    var style = context.GetAndAppendStyle("display:none;");
