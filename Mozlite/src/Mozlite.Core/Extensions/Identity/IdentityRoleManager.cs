...
namespace Mozlite.Extensions.Identity
{
    ...
    public abstract class IdentityRoleManager<TRole> : IIdentityRoleManager<TRole> where TRole : IdentityRole, new()
    {
        ...
        public virtual Task<IdentityResult> CreateAsync(TRole role, CancellationToken cancellationToken = new CancellationToken())
        {
            return _store.CreateAsync(role, cancellationToken);
        }
