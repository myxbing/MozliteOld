...
namespace Mozlite.TagHelpers.AdminMenus
{
    ...
    /// 后台管理导航。
    /// </summary>
    [HtmlTargetElement("navigator", Attributes = AttributeName)]
    [HtmlTargetElement("navigator", Attributes = HomeAttributeName)]
    [HtmlTargetElement("navigator", Attributes = HomeHrefAttributeName)]
    public class AdminMenuNavigatorTagHelper : ViewContextableTagHelper
    {
        private const string AttributeName = "x-name";
        private const string HomeAttributeName = "x-home";
        private const string HomeHrefAttributeName = "x-home-href";
